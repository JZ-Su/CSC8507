...
void GameLevel::CreateLevel3() {	
	//level3.objectList.push_back(CreateBoss(Vector3(20, 2, -30), Vector3(1, 1, 1), 0.0f));
	...
	level3.objectList.push_back(boss=CreateBoss(Vector3(0, 0, -60), Vector3(5, 5, 5), 0.0f));
...
void GameLevel::CreateLevel1_Stairs() {
	...
	level1.objectList.push_back(CreateStairs(Vector3(35, 10, 64), Vector3(1.25, 2, 2), 0.0f, Vector3(0, 1, 0), 180));
	level1.objectList.push_back(CreateCubeOBB(Vector3(35, 6.35, 76.4), Vector3(5, 10, 10), 0.0f, Vector3(1, 0, 0), -30));
	level1.objectList.push_back(CreateStairs(Vector3(-35, 10, 64), Vector3(1.25, 2, 2), 0.0f,Vector3(0, 1, 0), 180));
	level1.objectList.push_back(CreateCubeOBB(Vector3(-35, 6.35, 76.4), Vector3(5, 10, 10), 0.0f, Vector3(1, 0, 0), -30));

	level1.objectList.push_back(CreateStairs(Vector3(56, 0, 44), Vector3(2.5, 2, 2), 0.0f, Vector3(0, 1, 0), 90));
	level1.objectList.push_back(CreateCubeOBB(Vector3(43.7, -3.7, 44), Vector3(10, 10, 10), 0.0f, Vector3(0, 0, 1), -30));
	level1.objectList.push_back(CreateStairs(Vector3(-56, 0, 44), Vector3(2.5, 2, 2), 0.0f, Vector3(0, 1, 0), -90));
	level1.objectList.push_back(CreateCubeOBB(Vector3(-43.7, -3.7, 44), Vector3(10, 10, 10), 0.0f, Vector3(0, 0, 1), 30));
	level1.objectList.push_back(CreateStairs(Vector3(80, 0, 4), Vector3(2.5, 2, 2), 0.0f));
