...
void GameLevel::CreateGeneric() {	
	Generic.AddObject(CreatePlayer(Vector3(0, 10, 60), Vector3(2, 2, 2), 5.0f));
	//Level 4 player: 
...
void GameLevel::CreateLevel1() {
	...
	level1.AddObject(CreateCube(Vector3(-5, 6, -50), Vector3(5, 5, 5), 0.0f));
...
void GameLevel::CreateLevel2() {
	//level2.AddObject(CreateCube(Vector3(0, -2, 20), Vector3(60, 2, 80), 0.0f));
	//for (int i = 0; i < 7; ++i) {
	//	Vector3 position = Vector3(-60 + i * 20, 15, 40);
	//	level2.AddObject(CreateCube(position, Vector3(1, 15, 60), 0.0f));
	//}
	//for (int i = 0; i < 5; ++i) {
	//	Vector3 position = Vector3(50, 12.5, i * 20);
	//	level2.AddObject(CreateCube(position, Vector3(9, 12.5, 1), 0.0f));
	//	level2.AddObject(CreateCube(Vector3(-50, 12.5, position.z), Vector3(9, 12.5, 1), 0.0f));
	//	level2.AddObject(CreateCube(Vector3(-10, 12.5, position.z), Vector3(9, 12.5, 1), 0.0f));
	//	level2.AddObject(CreateCube(Vector3(10, 12.5, position.z), Vector3(9, 12.5, 1), 0.0f));
	//}
	//level2.AddObject(CreateCube(Vector3(-50, 12.5, -20), Vector3(9, 12.5, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(50, 12.5, -20), Vector3(9, 12.5, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(0, 15, -21), Vector3(21, 15, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(-30, 15, 0), Vector3(9, 15, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(30, 15, 0), Vector3(9, 15, 1), 0.0f));
	//for (int i = 0; i < 3; ++i) {
	//	Vector3 position = Vector3(-20 + i * 20, 12.5, -50);
	//	level2.AddObject(CreateCube(position, Vector3(1, 12.5, 9), 0.0f));
	//}
	//level2.AddObject(CreateCube(Vector3(-41, 15, -51), Vector3(1, 15, 9), 0.0f));
	//level2.AddObject(CreateCube(Vector3(41, 15, -51), Vector3(1, 15, 9), 0.0f));
	//level2.AddObject(CreateCube(Vector3(-60, 15, -30), Vector3(1, 15, 10), 0.0f));
	//level2.AddObject(CreateCube(Vector3(60, 15, -30), Vector3(1, 15, 10), 0.0f));
	//level2.AddObject(CreateCube(Vector3(-40, 15, -30), Vector3(1, 15, 10), 0.0f));
	//level2.AddObject(CreateCube(Vector3(40, 15, -30), Vector3(1, 15, 10), 0.0f));
	//level2.AddObject(CreateCube(Vector3(0, 15, 101), Vector3(60, 15, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(0, 15, -41), Vector3(60, 15, 1), 0.0f));
	//level2.AddObject(CreateCube(Vector3(0, 15, -60), Vector3(40, 15, 1), 0.0f));
	...
	////level2.AddObject(testAI);

	//float height = 7.0f;
	//level2.AddObject(CreateCube(Vector3(65, -2, 80), Vector3(65, 2, 80), 0.0f));
	//level2.AddObject(CreateCube(Vector3(32, height, 1), Vector3(10, height, 1)));
	//level2.AddObject(CreateCube(Vector3(54, height, 1), Vector3(10, height, 1)));
	//level2.AddObject(CreateCube(Vector3(76, height, 1), Vector3(10, height, 1)));
	//level2.AddObject(CreateCube(Vector3(98, height, 1), Vector3(10, height, 1)));
	//level2.AddObject(CreateCube(Vector3(21, height, 12), Vector3(1, height, 10)));
	//level2.AddObject(CreateCube(Vector3(43, height, 12), Vector3(1, height, 10)));
	//level2.AddObject(CreateCube(Vector3(65, height, 12), Vector3(1, height, 10)));
	//level2.AddObject(CreateCube(Vector3(87, height, 12), Vector3(1, height, 10)));

	vector<Vector3> pixelData;
	render->LoadMap(&pixelData, 512, 512);
...
void GameLevel::CreateLevel4_Normal() {
	...
	l2.AddObject(CreateCube(Vector3(-90, 10, 0), Vector3(10, 10, 60), 0.0f));
	...
	l2.AddObject(CreateCube(Vector3(0, 10, 90), Vector3(60, 10, 10), 0.0f));
	//other objects
	...
	l3.AddObject(CreateCube(Vector3(-90, 10, 0), Vector3(10, 10, 60), 0.0f));
	...
	l3.AddObject(CreateCube(Vector3(0, 10, 90), Vector3(60, 10, 10), 0.0f));
	//other objects
	...
	l4.AddObject(CreateCube(Vector3(-90, 10, 0), Vector3(10, 10, 60), 0.0f));
	...
	l4.AddObject(CreateCube(Vector3(0, 10, 90), Vector3(60, 10, 10), 0.0f));
	//other objects
	...
	l5.AddObject(CreateCube(Vector3(-90, 10, 0), Vector3(10, 10, 60), 0.0f));
	...
	l5.AddObject(CreateCube(Vector3(0, 10, 90), Vector3(60, 10, 10), 0.0f));
	//other objects
...
void GameLevel::CreateLevel1_Columns() {
	...
	level1.AddObject(CreateCapsule(Vector3(-50, 40, -60), 50, 4, 0.0f));
	...
	level1.AddObject(CreateCapsule(Vector3(-50, 40, -20), 50, 4, 0.0f));
